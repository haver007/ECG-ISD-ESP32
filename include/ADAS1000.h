...
#define ADAS1000_ECGCTL_GAIN 		(1ul << 9)	/* 	Pre-Amp & Anti-Aliasing Filter Overall Gain: 
...
#define  ADAS1000_ECGCTL_CHCONFIG_SINGLE_ENDED_INPUT	0b00
#define  ADAS1000_ECGCTL_CHCONFIG_DIFFERENTIAL_INPUT	0b01

#define  ADAS1000_ECGCTL_GAIN_GAIN0						0b00
#define  ADAS1000_ECGCTL_GAIN_GAIN1 					0b01
#define  ADAS1000_ECGCTL_GAIN_GAIN2 					0b10
#define  ADAS1000_ECGCTL_GAIN_GAIN3 					0b11

#define  ADAS1000_ECGCTL_CLKEXT_XTAL 					0b00
#define  ADAS1000_ECGCTL_CLKEXT_CLK_IO 					0b01

#define ADAS1000_ECGCTL_MASTER_SLAVE					0b00
#define ADAS1000_ECGCTL_MASTER_MASTER					0b01

#define ADAS1000_ECGCTL_GANG_SINGLECHANNELMODE			0b00
#define ADAS1000_ECGCTL_GANG_GANGMODE					0b01

#define ADAS1000_ECGCTL_HP_1MSPS						0b00
...
#define ADAS1000_TESTTONE_TONTYPE	(1ul << 4)	/*	00 = 10Hz Sine Wave
01 = 150Hz Sine Wave
...
#define ADAS1000_TESTTONE_TONTYPE_SIN_WAVE_10HZ		0b00 
#define ADAS1000_TESTTONE_TONTYPE_SIN_WAVE_150HZ	0b01 
#define ADAS1000_TESTTONE_TONTYPE_SQUARE_WAVE_1HZ	0b10 

#define ADAS1000_TESTTONE_TONINT_EXTERNAL		0b00
#define ADAS1000_TESTTONE_TONINT_INTERNAL		0b01
...
1  = Electrode Format */
#define ADAS1000_FRMCTL_SKIP			(1ul << 3)	/*	Skip interval  this field provides a way to decimate the data
00 = output every frame
01 = output every other frame
1x = output every 4th frame */

#define ADAS1000_FRMCTL_DATARATE		(1ul << 1)


#define ADAS1000_FRMCTL_DATAFMT_DIGITAL			0b00
#define ADAS1000_FRMCTL_DATAFMT_ELECTRODE		0b01


#define  ADAS1000_FRMCTL_SKIP_NONE_FRAME		0b00
#define  ADAS1000_FRMCTL_SKIP_2TH_FRAME			0b01
#define  ADAS1000_FRMCTL_SKIP_4TH_FRAME			0b10

#define ADAS1000_FRMCTL_FRMRATE_2KHZ			0b00		/*	Sets the Output Data Rate to 2 kHz */
#define ADAS1000_FRMCTL_FRMRATE_16KHZ			0b01		/*	Sets the Output Data Rate to 16 kHz */
#define ADAS1000_FRMCTL_FRMRATE_128KHZ			0b10		/*	Sets the Output Data Rate to 128 kHz */
#define ADAS1000_FRMCTL_FRMRATE_31_25HZ			0b11		/*	Sets the Output Data Rate to 31.25 Hz */
...
0x3B : PACE2DATA
0x3C : PACE3DATA */
#define	ADAS1000_PACE_DATA_HEIGHT	(1ul << 8)	/*	Measured pace height in signed 2s complement value
0 = 0
1 = VREF / GAIN / 2^16
N = N * VREF / GAIN / 2^16 */
...
/******************************************************************************/
#define ADAS1000_FRAMES_MARKER					(1ul << 31)	/*	Header marker, set to 1 for the header */
...
public:
	...
	void setFRMCTL_LeadOffStatusEnabled(bool enabled);
	void setFRMCTL_GPIOWordEnabled(bool enabled);
	void setFRMCTL_CRCWordEnabled(bool enabled);
	...
	void setTESTTONE_External(void);
	void setTESTTONE_Internal(void);
	void setTESTTONE_OutPutEnabled(bool enabled);
	void setTESTTONE_ModeEnabled(bool enabled);

	void setECGCTL_ChannelLAEnabled(bool enabled);
	void setECGCTL_ChannelLLEnabled(bool enabled);
	...
	void setECGCTL_Gain3(void);
	void setECGCTL_VREFBufferEnabled(bool enabled);
	void setECGCTL_CrystalOscillatorXTAL(void);
	void setECGCTL_ExternalClock(void);
	void setECGCTL_SingleChannelMode(void);
	void setECGCTL_GangMode(void);
	void setECGCTL_MasterMode(void);
	void setECGCTL_SlaveMode(void);
	void setECGCTL_LowPower1MSPS(void);
	void setECGCTL_HighPerformance2MSPS(void);
	void setECGCTL_ADCConversionEnabled(bool enabled);
